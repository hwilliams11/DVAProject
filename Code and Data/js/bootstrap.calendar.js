...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype.init = function () {
        ...
        this.element.find('#last').on({ click: $.proxy(this.on_prev, this)});
        this.element.find('#current').on({ click: $.proxy(this.on_current, this)});
        this.element.find('#next').on({ click: $.proxy(this.on_next, this)});
...
*/
    Plugin.prototype.renderCalendar = function (date) {
        ...
        this.calendar.find(".year").empty();
        this.calendar.find(".month").empty();

        this.calendar.find(".year").append(mon.getFullYear());
        this.calendar.find(".month").append(this.months[mon.getMonth()]);
    ...
    Plugin.prototype.renderDays = function () {
        ...
        for(var j=this.weekStart; j<this.weekStart + 7; j++){
            html += '<div class="myspn1 tab_header">' + this.days[j%7] + '</div>';
